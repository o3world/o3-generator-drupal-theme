    ...
    import TabsToAccordion from "../tabs-to-accordion.twig";
    import docs from "./tabs-to-accordion.doc.mdx";

    export default {
      title: 'Component / Tabs To Accordion',
      parameters: {
        docs: {
          page: docs,
        },
    ...
    const Template = (args) => TabsToAccordion({...args});
